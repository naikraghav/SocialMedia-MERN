...
const MarketplaceLogo = ({ className = "" }) => (
  <svg
    viewBox="0 0 24 24"
    fillRule="currentColor"
    className={className} // Tailwind classes from parent
    xmlns="http://www.w3.org/2000/svg"
  >
...
const Grid = () => (
  <svg
    ...
    fillRule="currentColor"
    aria-hidden="true"
    // style="--x-colox1qfuztqr: var(--primary-icon);"
  >
